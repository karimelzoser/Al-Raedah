...
@Component({
  ...
  styleUrls: ['./mobile-order.component.css'],
})
export class MobileOrderComponent implements OnInit {
  ...
  showing: boolean;
  serviceName;
  services: any = ['تصميم تطبيقات الموبايل'];
  servicesAr: any = ['Develop Mobile Application'];
  toggling;
  ...
  onSubmitOrder() {
    ...
    console.log(orders);
    this.firestoreService.create_newOrderMobile(orders);
    this.initOrderForm();
    this.formpop();
  }
