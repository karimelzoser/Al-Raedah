...
@Component({
  selector: 'app-net-imp-order-list',
  templateUrl: './net-imp-order-list.component.html',
  styleUrls: ['./net-imp-order-list.component.css'],
})
export class NetImpOrderListComponent implements OnInit {
  id;
  @Output() isClicked;
  orders: OrdernetImp[];
